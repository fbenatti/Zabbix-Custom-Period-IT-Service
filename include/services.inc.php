...
function createServiceMonitoringTree($period_start=null, $period_end=null, array $services, array $slaData, $period, &$tree, array $parentService = array(), array $service = array(), array $dependency = array()) {
	...
	if (!$dependency || $dependency['soft'] == 0) {
		...
		#	createServiceMonitoringTree($services, $slaData, $period, $tree, $service, $childService, $dependency);
                        createServiceMonitoringTree($period_start, $period_end, $services, $slaData, $period, $tree, $service, $childService, $dependency);
